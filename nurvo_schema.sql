-- ============================================================
-- Nurvo PostgreSQL Schema  (完整版)
-- 使用方式：
--   Step 1 → 在 pgAdmin 連到預設 postgres 資料庫執行
--   Step 2 → 切換到 nurvo 資料庫後執行剩下所有 SQL
-- ============================================================
...
CREATE TABLE IF NOT EXISTS chat_messages (
    id               VARCHAR(255) PRIMARY KEY,   -- app 端的 UUID 字串
    session_id       UUID         NOT NULL REFERENCES game_sessions(id) ON DELETE CASCADE,
    sender           VARCHAR(50)  NOT NULL,       -- nurse / patient / family_0~2
